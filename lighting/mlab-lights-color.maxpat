...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 189.666626, 902.0, 421.0, 23.0 ],
					"style" : "wm20150520a",
					"text" : "imp.artnet.controller @unicast 1 @unicast_ip 10.7.158.185"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "lights.json",
				"bootpath" : "~/Google Drive/patches/ESS-S16/lighting/settings",
				"patcherrelativepath" : "../../../../Google Drive/patches/ESS-S16/lighting/settings",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "mlab-lights-px.maxpat",
				"bootpath" : "~/Google Drive/patches/ESS-S16/lighting/lib",
				"patcherrelativepath" : "../../../../Google Drive/patches/ESS-S16/lighting/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
